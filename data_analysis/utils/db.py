...
def update_publications(publications, table_name, conn, batch_size: int = None):
    """
    Save publications
...
def batch_update_publications(publications: list, table_name: str, conn, batch_size: int = 2000):
    """
    Update publications data in batches of the given size
    ...
    for start in range(0, num_publications, batch_size):
        batch_publications = publications[start:start+batch_size]
        update_publications(batch_publications, table_name, conn)
